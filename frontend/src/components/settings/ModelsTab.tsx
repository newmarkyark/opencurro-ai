...
const providers: ProviderId[] = ['openrouter', 'groq', 'nvidia', 'fireworks', 'ollama_cloud', 'opencode_zen', 'ai_302']
...
const PROVIDER_META: Record<ProviderId, { description: string; iconClass: string }> = {
  ...
  ai_302: { description: 'Pay-as-you-go AI resource marketplace', iconClass: 'bg-[rgba(245,158,11,0.12)] text-[#f59e0b]' },
}
