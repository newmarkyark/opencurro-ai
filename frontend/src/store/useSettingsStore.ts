...
export const useSettingsStore = create<SettingsState>()(
  persist(
    (set) => ({
      providerKeys: { openrouter: '', groq: '', nvidia: '', fireworks: '', ollama_cloud: '', opencode_zen: '', '302_ai': '' },
      providerBaseUrls: {
      ...
      firecrawlApiKey: '',
      providerCatalog: [],
      modelsByProvider: { openrouter: [], groq: [], nvidia: [], fireworks: [], ollama_cloud: [], opencode_zen: [], '302_ai': [] },
      subAgents: [],
